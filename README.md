...
An independent, design-forward public web app exploring Nigeria's history and credible long-range future across **13 sectors** (6 MVP + 7 expansion), a 150-person Icons register, and 26 Cool Projects.

**Build status (Aug 18, 2026):** MVP and most Phase 2 content are in the repo — including Icons of Nigeria, Cool Projects, and server-side Ask the Archive. Production launch is still blocked on editorial review and Vercel deploy. Localization, TTS audio, commissioned art, and WebGL are deferred — see [Build Plan](./docs/BUILD_PLAN.md).
