...
export const COOL_PROJECTS: CoolProject[] = [
  ...
  },
  {
    ...
    detail:
      "The 100 km rule is a rural floor. In cities, the standard should tighten to a branch within about 2–3 km, or one per 50,000 people, whichever is denser. Every branch needs a minimum kit: a children’s section, study seats, working toilets, electricity, a librarian, and wifi. Add mobile libraries for riverine and pastoral routes, legal-deposit copies of Nigerian publications, and evening hours for workers. Finland’s library law treats this as infrastructure; Carnegie networks and the UK county system show how a thin grid becomes a habit. Pair buildings with a national catalogue so a title in Makurdi can be requested in Maiduguri.",
  ...
  },
  {
    ...
    summary:
      "Digitise Certificates of Occupancy and make ownership searchable, so mortgages, planning, and inheritance can be checked.",
    detail:
  ...
  },
  {
    ...
    summary:
      "Define catchment areas so every neighbourhood has a primary-care clinic within a published walking or transit time.",
    detail:
      "The NHS and several European systems plan primary care by geography: a list, a building, a nurse, a referral path. Nigeria’s 2050 health case needs the unglamorous layer beneath tertiary hospitals, immunisation, antenatal, hypertension, trauma first response. Publish maps of uncovered wards, staff the gaps, and stop counting hospital beds as if they were access. Pair with the civil registry so a child’s immunisation record lives on the registry.",
  ...
  },
  {
    ...
    summary:
      "An open portal for federal and state budgets, tenders, and contract awards, searchable the week they are signed.",
    detail:
  ...
  },
  {
    ...
    summary:
      "Treat public green space as a planning standard: shade, a bench, a pitch.",
    detail:
  ...
  },
  {
    ...
    summary:
      "Single-window customs, published dwell times, and a queue you can see, so a container clears on a published clock.",
    detail:
      "Apapa and Onne already move the country’s trade; they also warehouse it. A working port is a clock: electronic single window, joint inspections, a published dwell-time dashboard, and a truck appointment that holds at the gate. Singapore, Rotterdam, and Morocco’s Tanger Med made speed a public metric. Manufacturing and the non-oil economy cannot diversify if a generator part sits six weeks in a stack. The work is the software and the discipline of the harbour we have.",
  ...
  },
  {
    ...
    summary:
      "A public case diary, hearing date, courtroom, adjournment reason, so justice is a calendar.",
    detail:
  ...
  },
  {
    ...
    summary:
      "A national stock map for blood units and medical oxygen, so a night-time emergency is a logistics problem.",
    detail:
  ...
  },
  {
    ...
    detail:
      "Coverage maps already look complete from a laptop in Victoria Island. A utility standard would publish speed, price per GB, and outage hours by LGA, then fund last-mile backhaul the way rural electrification was supposed to work. South Korea’s broadband as infrastructure and Kenya’s national fibre backbone show that the last mile is a policy. Education, tech jobs, and open government all assume a connection that a teacher in Gashua can pay for. Start with schools, PHCs, and local-government secretariats, then the street.",
