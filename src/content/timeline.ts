...
export const TIMELINE_ERAS = [
  {
    ...
    description: "Kingdoms, empires, and city-states across the region, long before one country.",
  },
  {
    id: "colonial",
