...
export const NIGERIA_MAP_REGIONS: NigeriaMapRegion[] = [
  {
    ...
    sectorSlugs: ["security", "agriculture", "education", "transportation", "real-estate", "tourism"],
  ...
  },
  {
    ...
    summary:
      "Lake Chad, recovery from insurgency, Yankari and Sukur, and a food-and-health rebuild that has to hold if national human-capital targets are real.",
    sectorSlugs: ["security", "agriculture", "healthcare", "real-estate", "tourism"],
  ...
  },
  {
    ...
    sectorSlugs: ["governance", "agriculture", "education", "transportation", "real-estate", "tourism"],
  ...
  },
  {
    ...
    summary:
      "Lagos and the Yoruba hinterland, tech, finance, ports, Osun-Osogbo, soaring housing costs, and the densest 2050 economic case on the map.",
    sectorSlugs: ["technology", "economy", "financial-inclusion", "creative-economy", "transportation", "real-estate", "tourism"],
  ...
  },
  {
    ...
    sectorSlugs: ["manufacturing", "technology", "economy", "transportation", "real-estate", "tourism"],
  ...
  },
  {
    ...
    summary:
      "The Niger Delta, oil, gas, ports, Calabar Carnival and Obudu, and the energy transition Nigeria has to make without stranding the region that funded the state.",
    sectorSlugs: ["energy", "economy", "healthcare", "transportation", "real-estate", "tourism"],
