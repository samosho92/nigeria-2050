            ...
            <div key={range.label}>
              ...
              <div className="grid grid-cols-3 gap-2 text-center text-sm">
                <div className="rounded-lg bg-muted p-3">
                  ...
                  <p className="mt-1 font-bold">{range.low}{range.unit ? ` ${range.unit}` : ""}</p>
                </div>
                <div className="rounded-lg border border-accent bg-accent/10 p-3">
                  <p className="text-xs uppercase text-accent">Base</p>
                  <p className="mt-1 font-bold text-accent">{range.base}{range.unit ? ` ${range.unit}` : ""}</p>
                </div>
                <div className="rounded-lg bg-muted p-3">
                  <p className="text-xs uppercase text-muted-foreground">High</p>
                  <p className="mt-1 font-bold">{range.high}{range.unit ? ` ${range.unit}` : ""}</p>
                </div>
              </div>
            </div>
          ))}
