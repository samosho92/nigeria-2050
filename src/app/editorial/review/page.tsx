...
export const metadata: Metadata = {
  ...
  description: "Internal editorial review status for Naija2050 content before public launch.",
};
...
export default function EditorialReviewPage() {
  ...
  return (
    <Container size="narrow" className="py-16">
      <PageHeader
        title="Editorial Review Queue"
        description="Human review pass for sensitive history, sector projections, and AI-generated art — per PRD §13 and §9.5."
      />

      <p className="mt-6 rounded-lg border border-border bg-muted p-4 text-sm text-muted-foreground">
        {pending.length} item{pending.length === 1 ? "" : "s"} pending review before launch sign-off.
      </p>
