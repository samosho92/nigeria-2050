...
export default function ComparePage() {
  ...
  return (
    <Container size="narrow" className="py-16">
      ...
      <Link
        href="/compare/g7"
        className="mt-6 flex items-center justify-between gap-4 rounded-xl border border-accent/30 bg-accent/5 px-5 py-4 transition hover:border-accent hover:bg-accent/10"
      >
        <div>
