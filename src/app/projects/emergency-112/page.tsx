...
export const metadata: Metadata = {
  ...
  description:
    "A schematic public-safety desk: one number, a postal-code location, trained dispatch, radio ACK — or the number stays unpublished. Not a live emergency service.",
};
  ...
  return (
    <>
      <PageHero
        ...
        description={`${DISPATCH_CLUSTERS.length} seed clusters. ${EMERGENCY_STANDARD.number} is a desk: answer, locate on a postal code, classify, radio ACK. A cluster that rings into voicemail does not get the number. This is a schematic — not a live PSAP.`}
