...
export const metadata: Metadata = {
  title: "Icons",
  description:
    "150 Nigerians — past and present — whose work shaped the country’s political, economic, and cultural life. Searchable, chronological, and sourced.",
};
